...
private:
	...
	std::vector<KX_Material *> m_materials;
	...
	std::map<Material *, KX_Material *> m_map_mesh_to_polyaterial;
...
public:
	...
	void RegisterMaterial(KX_Material *blmat, Material *mat);
	KX_Material *FindMaterial(Material *mat) const;
	...
	const std::vector<KX_Material *>& GetMaterials() const;
};
